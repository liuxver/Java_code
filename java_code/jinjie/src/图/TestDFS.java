package ͼ;
//import javax.swing.*;
public class TestDFS {//extends JApplet {
    public static void main(String[] args){
    	...
    	//BinaryTree<Integer> binaryTree=dfs.toBinaryTree();
    	//add(new TreeControl(binaryTree));
        ...
        java.util.List<Integer> searchOrders1=bfs.getSearchOrders();
    	...
    	for(int i=0;i<searchOrders1.size();i++){
    		System.out.print(graph.getVertex(searchOrders1.get(i))+" ");
